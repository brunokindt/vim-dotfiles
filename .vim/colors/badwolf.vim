...
if exists('g:badwolf_darkgutter') && g:badwolf_darkgutter
    ...
    let s:gutter = 'darkgravel'
endif

if exists('g:badwolf_darkbackground') && g:badwolf_darkbackground
    let s:background = 'blackestgravel'
    if exists('g:badwolf_darkgutter') && g:badwolf_darkgutter
        let s:gutter = 'coal'
    endif
else
    let s:background = 'darkgravel'
    let s:gutter = 'darkgravel'
endif
...
call s:HL('Normal', 'plain', s:background)
